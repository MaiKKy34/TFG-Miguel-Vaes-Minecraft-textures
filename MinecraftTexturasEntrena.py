...
if __name__ == '__main__':
    ...
    root_dir = 'D:/URJC/TFG/Texturas/Minecraft/Texturas/1AADATASET'
    ...
    for epoch in range(epochs):
        ...
        for batch_features, _ in train_loader:
            batch_features = batch_features.view(-1, 16 * 16 * 4).to(device)  # Ajustar el tamaño de entrada
            optimizer.zero_grad()
    ...
    torch.save(model.state_dict(), 'modelo_vae_Minecraft.pth')
